...
(function() {
	...
	// "On Visible" animations.
		onvisible.add('.container.style1', { style: 'slide-right', speed: 1000, intensity: 5, delay: 0, replay: true });
		onvisible.add('.container.style1 > .wrapper > .inner', { style: 'slide-right', speed: 1000, intensity: 5, delay: 0, replay: true });
		onvisible.add('#image01', { style: 'blur-in', speed: 1000, intensity: 5, delay: 1000, replay: false });
		onvisible.add('#text01', { style: 'blur-in', speed: 1000, intensity: 5, delay: 1000, replay: true });
		onvisible.add('#image02', { style: 'blur-in', speed: 1000, intensity: 5, delay: 1000, replay: false });
		onvisible.add('h1.style1, h2.style1, h3.style1, p.style1', { style: 'blur-in', speed: 1000, intensity: 5, delay: 1000, replay: true });
		onvisible.add('#table01', { style: 'blur-in', speed: 1000, intensity: 5, delay: 1000, replay: false });
		onvisible.add('#list01', { style: 'blur-in', speed: 1000, intensity: 5, delay: 1000, replay: true });
		onvisible.add('#image04', { style: 'blur-in', speed: 1000, intensity: 5, delay: 1000, replay: false });
		onvisible.add('h1.style2, h2.style2, h3.style2, p.style2', { style: 'blur-in', speed: 1000, intensity: 5, delay: 1000, replay: true });
		onvisible.add('#image09', { style: 'blur-in', speed: 1000, intensity: 5, delay: 1000, replay: false });
		onvisible.add('#image05', { style: 'blur-in', speed: 1000, intensity: 5, delay: 1000, replay: false });
		onvisible.add('#image06', { style: 'blur-in', speed: 1000, intensity: 5, delay: 1000, replay: false });
		onvisible.add('#image08', { style: 'blur-in', speed: 1000, intensity: 5, delay: 1000, replay: false });
		onvisible.add('#image07', { style: 'blur-in', speed: 1000, intensity: 5, delay: 1000, replay: false });
		onvisible.add('#image10', { style: 'blur-in', speed: 1000, intensity: 5, delay: 1000, replay: false });
		onvisible.add('#image11', { style: 'blur-in', speed: 1000, intensity: 5, delay: 1000, replay: false });
		onvisible.add('#list02', { style: 'blur-in', speed: 1000, intensity: 5, delay: 1000, replay: true });
		onvisible.add('#list03', { style: 'blur-in', speed: 1000, intensity: 5, delay: 1000, replay: true });
		onvisible.add('#image03', { style: 'blur-in', speed: 1000, intensity: 5, delay: 1000, replay: false });
